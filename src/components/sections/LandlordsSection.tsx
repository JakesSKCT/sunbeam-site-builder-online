      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="text-center group">
            <div className="mx-auto mb-8 p-6 bg-gradient-to-br from-green-100 to-green-200 rounded-3xl border border-green-200 w-fit group-hover:scale-110 transition-transform duration-300">
              <TrendingUp className="h-16 w-16 text-green-600" />
            </div>
            <h3 className="text-2xl font-semibold mb-4 text-gray-900">Increased Property Value</h3>
            <div className="bg-green-50 border border-green-200 p-4 rounded-lg mb-4">
              <p className="text-2xl font-bold text-green-600 mb-1">15-20%</p>
              <p className="text-sm text-green-700">Average property value increase</p>
            </div>
          ...
          <div className="text-center group">
            <div className="mx-auto mb-8 p-6 bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl border border-blue-200 w-fit group-hover:scale-110 transition-transform duration-300">
              <Home className="h-16 w-16 text-blue-600" />
            </div>
            <h3 className="text-2xl font-semibold mb-4 text-gray-900">Attract Quality Tenants</h3>
            <div className="bg-blue-50 border border-blue-200 p-4 rounded-lg mb-4">
              <p className="text-2xl font-bold text-blue-600 mb-1">85%</p>
              <p className="text-sm text-blue-700">Prefer eco-friendly homes</p>
            </div>
            <ul className="text-gray-600 text-lg leading-relaxed space-y-2">
          ...
          <div className="text-center group">
            <div className="mx-auto mb-8 p-6 bg-gradient-to-br from-purple-100 to-purple-200 rounded-3xl border border-purple-200 w-fit group-hover:scale-110 transition-transform duration-300">
              <Calculator className="h-16 w-16 text-purple-600" />
            </div>
            <h3 className="text-2xl font-semibold mb-4 text-gray-900">Tax Benefits</h3>
            <div className="bg-purple-50 border border-purple-200 p-4 rounded-lg mb-4">
              <p className="text-2xl font-bold text-purple-600 mb-1">Section 12B</p>
              <p className="text-sm text-purple-700">Tax allowance available</p>
            </div>
            <ul className="text-gray-600 text-lg leading-relaxed space-y-2">
          ...
          {/* Reliable Investment */}
          <div className="text-center group">
            <div className="mx-auto mb-8 p-6 bg-gradient-to-br from-orange-100 to-orange-200 rounded-3xl border border-orange-200 w-fit group-hover:scale-110 transition-transform duration-300">
              <Shield className="h-16 w-16 text-orange-600" />
            </div>
            <h3 className="text-2xl font-semibold mb-4 text-gray-900">Reliable Investment</h3>
            <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg mb-4">
              <p className="text-2xl font-bold text-orange-600 mb-1">25 Years</p>
              <p className="text-sm text-orange-700">Warranty & performance</p>
            </div>
            <ul className="text-gray-600 text-lg leading-relaxed space-y-2">
        ...
        {/* Maximum ROI Section */}
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg mb-16">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6 mb-8">
                ...
                <DialogTrigger asChild>
                  <div className="cursor-pointer hover:opacity-90 transition-opacity">
                    <img 
                      ...
                      className="w-full h-auto rounded-lg shadow-md border border-gray-300 hover:border-blue-400 transition-colors"
                    />
                    <p className="text-center text-sm text-blue-600 mt-2">Click to view larger image</p>
                  </div>
                </DialogTrigger>
            ...
            <div className="bg-gray-50 border border-green-200 rounded-lg p-6 mb-8">
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-green-600 mb-2">R2,632,163 - R90,000 = R2,542,163</p>
            ...
            <div className="mb-8">
              <h4 className="text-lg font-semibold text-gray-900 mb-4 text-center">Annual and Cumulative Income Over 20 Years</h4>
              <img 
