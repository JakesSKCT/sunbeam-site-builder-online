      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="text-center group">
            <div className="mx-auto mb-8 p-6 bg-gradient-to-br from-green-500/20 to-green-600/20 rounded-3xl border border-green-500/30 w-fit group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="text-center group">
            <div className="mx-auto mb-8 p-6 bg-gradient-to-br from-blue-500/20 to-blue-600/20 rounded-3xl border border-blue-500/30 w-fit group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="text-center group">
            <div className="mx-auto mb-8 p-6 bg-gradient-to-br from-purple-500/20 to-purple-600/20 rounded-3xl border border-purple-500/30 w-fit group-hover:scale-110 transition-transform duration-300">
              <Calculator className="h-16 w-16 text-purple-400" />
            </div>
          ...
          {/* Reliable Investment */}
          <div className="text-center group">
            <div className="mx-auto mb-8 p-6 bg-gradient-to-br from-orange-500/20 to-orange-600/20 rounded-3xl border border-orange-500/30 w-fit group-hover:scale-110 transition-transform duration-300">
        ...
        {/* Maximum ROI Section */}
        <div className="bg-gray-800/50 border border-gray-700 rounded-2xl p-8 shadow-lg mb-16">
